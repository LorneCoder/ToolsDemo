...
//第三步设备应答
//随机数原始数据
@property (nonatomic, copy) NSString *thirdNum1;
@property (nonatomic, copy) NSString *thirdNum2;
...
//        if (self.thirdNum1 && self.thirdNum2) {
//            return;
//        }
        ...
        NSString *randomNum2 = [tempStr substringWithRange:NSMakeRange(0, 2)];
        NSLog(@"随机数1：%@ ---- 随机数2：%@", randomNum1, randomNum2);
        self.thirdNum1 = randomNum1;
        self.thirdNum2 = randomNum2;
...
{
    NSArray *arr = [BLEPrinterTool cyn_sendDataToPrinterWithSN:self.deviceSN];
